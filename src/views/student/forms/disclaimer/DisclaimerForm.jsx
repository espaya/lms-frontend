...
export default function DisclaimerForm({ fullname }) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${apiBase}/api/user/disclaimer-forms`, {
        method: "POST",
        credentials: "include",
  ...
  // Progress steps
  const steps = ["Acknowlegement", "Signature", "Success"];
                            ...
                            <div className="row">
                              <div className="col-12">
                                ...
                                <p>
                                  ...
                                  Licensure and Certification. I understand that
                                  the falsification of documents, particularly
                                  those pertaining to the submission of visit
                                  notes where in fact no visits was made, is
                                  considered to be fraud and is subject to
                                  filing of a criminal grievance, civil and/or
                                  criminal prosecution, and immediate
                                  termination. I therefore hold the home health
                                  care agency, its shareholders, directors and
                                  officers, harmless from any falsified
                                  documents.
                                </p>
                                <p>
                                  <strong>
                                    ...
                                    falsification of documents, particularly
                                    those pertaining to the submission of visit
                                    notes where in fact no visits was made, is
                                    considered to be fraud and is subject to
                                    filing of a criminal grievance, civil and/or
