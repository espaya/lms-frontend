      ...
      <div className="col-lg-6 col-xl-9">
        <div className="card">
          ...
          <div className="card-body text-center">
            ...
            >
              <svg width={410} height={530}>
                <g transform="scale(0.43157894736842106) translate(0, 339.0243902439025)">
                  <path
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeOpacity="0.25"
                    fill="rgba(89, 59, 219, 0.5)"
                    original="rgba(89, 59, 219, 0.5)"
                    id="jqvmap1_ru"
                    className="jqvmap-region"
                  />
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeOpacity="0.25"
                    fill="rgba(89, 59, 219, 0.6)"
                    original="rgba(89, 59, 219, 0.6)"
                    id="jqvmap1_us"
                    className="jqvmap-region"
                  />
                  <path
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeOpacity="0.25"
                    fill="rgba(89, 59, 219, 1)"
                    original="rgba(89, 59, 219, 1)"
                    id="jqvmap1_in"
                    className="jqvmap-region"
                  />
                  <path
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeOpacity="0.25"
                    fill="rgba(89, 59, 219, 0.7)"
                    original="rgba(89, 59, 219, 0.7)"
                    id="jqvmap1_tr"
                    className="jqvmap-region"
                  />
                  <path
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeOpacity="0.25"
                    fill="rgba(89, 59, 219, 0.8)"
                    original="rgba(89, 59, 219, 0.8)"
                    id="jqvmap1_gb"
                    className="jqvmap-region"
                  />
                  <path
